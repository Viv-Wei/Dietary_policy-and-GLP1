...
def main(a):
    ...
    print(f"=== Full method: cumulative avertable deaths over {a.years} years (thousands, by arm) ===")
    print((t.groupby(["arm","iso3"]).averted_10yr.sum()/1000).round(1).unstack(0).to_string())
    print("\n=== Lag shape: year 1 vs year 10 (IHD, whole population) ===")
