...
FALLBACK_SHARE = {
 "CHN": {"q1":6.5,"q2":10.9,"q3":15.9,"q4":23.0,"q5":43.7},
 "IND": {"q1":8.1,"q2":11.4,"q3":15.2,"q4":21.3,"q5":44.0},
 "USA": {"q1":5.2,"q2":10.2,"q3":15.3,"q4":22.8,"q5":46.5},
 "BRA": {"q1":3.4,"q2":7.7,"q3":12.4,"q4":19.7,"q5":56.8},
 "NGA": {"q1":7.5,"q2":11.5,"q3":15.5,"q4":21.5,"q5":44.0},
}
FALLBACK_GNI = {"CHN":13400,"IND":2540,"USA":80450,"BRA":9070,"NGA":1930}
...
print("\nAPI status:", "all retrieved online" if api_ok else "partly/all fallback values (verify on World Bank website before submission)")
