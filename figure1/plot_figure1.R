...
stopifnot(length(unique(d$iso3)) == 20)

CH_LV <- c("Full convergence - structurally reachable","High convergence - mostly reachable","Partial convergence - partly reachable",
